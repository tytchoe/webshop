        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{ route('admin.brand.update', ['brand' => $brand->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10" >
                                    <input id="name" name="name" type="text" class="form-control" placeholder="" value="{{ $brand->name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    @if($brand->image && file_exists(public_path($brand->image)))
                                        <img src="{{ asset($brand->image) }}" width="100" height="75" alt="">
                                    @else
                            ...
                            <div class="col-sm-offset-2 col-sm-10">
                                <div class="checkbox">
                                    <label>
                                        <input  @if($brand->is_active == 1) checked @endif value="1" type="checkbox" name="is_active" id="is_active"> Hiển thị
                                    </label>
                                </div>
                            </div>
